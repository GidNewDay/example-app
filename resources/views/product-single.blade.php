        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{  $product[0]->preview }}" class="image-popup"><img
                            src="{{ $product[0]->preview }}" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group d-flex">
                                <div class="select-wrap">
                                    ...
                                    <?php
                                    $sizes = json_decode($product[0]->size);
                                    $eu_sizes = ['Small','Medium','Large','Extra Large']
                                    ?>
                                    <select name="" id="" class="form-control">
                                        @foreach($sizes as $size)
                                            <option value="">{{$eu_sizes[$size-1]}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
